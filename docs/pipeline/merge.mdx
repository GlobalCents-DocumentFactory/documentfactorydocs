...
Determines whether the merge process should be part of the pipeline.
...
Provides detailed configuration options for the merge process. This is an extension that allows for more granular control
over how the merge is carried out.
