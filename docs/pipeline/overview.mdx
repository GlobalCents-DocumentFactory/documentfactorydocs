...
Each action is enabled using a dedicated flag (e.g., `actionconvert`) and can be supplemented with a corresponding
configuration object (e.g., `actionconvert`) for more granular control over how the action behaves.
