...
*Type:* <code style={{ color: '#0066cc' }}>boolean (default = 150)</code>
...
*Type:* <code style={{ color: '#0066cc' }}>boolean (default = 100)</code>
...
PDF format for generated documents, such as during the [**conversion**](docs/pipeline/processors/convert.mdx) process,
