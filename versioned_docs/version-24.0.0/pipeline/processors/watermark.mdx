...
For more detailed information about using dynamic data, refer to the [**Metadata**](../metadata.mdx) section.
...
This property is an object, the structure of which is described in the [**Artifact**](../../references/artifact.mdx) section.
